...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "8beb8718-238e-4fde-afd0-aaf1e6211434"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "ce0ec1fb-02ec-4546-9c54-a509a9cddcaa"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "e97719a2-c118-4356-818c-421267122253"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "a201a72b-a145-4d01-8daf-535bfdc85c1a"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "67a16638-5c6f-4087-86c9-0494e67a5dd8"
  }
}
