...
resource "google_storage_bucket" "static-site" {
  ...
  //  }
  labels = {
    yor_trace = "ba9f77dc-9e95-4da0-9ec6-5ff58f1ec4e6"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    yor_trace = "0b7f9f33-79d6-4454-af06-037f093b20f5"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    yor_trace = "e96316d4-dc7b-4973-ad81-25e57cb770b4"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    yor_trace   = "8e045868-1836-43d2-9103-f73dd2d87e60"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    yor_trace = "0780ac7a-d114-420c-82ed-72a4df143655"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    yor_trace = "ab54ebdb-8fd3-4621-bfee-b34962bafab2"
  }
}
